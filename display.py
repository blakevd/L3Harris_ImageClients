## This code was inspired and is heavily modified from https://makersportal.com/blog/2020/6/8/high-resolution-thermal-camera-with-raspberry-pi-and-mlx90640
## This has run in a virtual python enviroment that has dependencies
## Raspberry pi i2c baudrate is set to 1Mbps
...
cbar_label = cbar.set_label('Temperature [$^{\circ}$C]', fontsize=14)  # colorbar label
